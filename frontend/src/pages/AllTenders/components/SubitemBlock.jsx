          ...
          <div className="ml-[72px] w-[calc(100%-72px)] rounded-2xl border border-slate-200 bg-white">
            <table className="w-full border-collapse text-[0.7rem] text-slate-700">
              <thead className="bg-slate-50">
                <tr>
                  <td className="w-[260px] min-w-[260px] max-w-[260px] rounded-tl-2xl bg-slate-50 px-4 py-3 text-center text-[0.7rem] font-semibold uppercase tracking-[0.12em] text-slate-800">
                    Activity
                  </td>
